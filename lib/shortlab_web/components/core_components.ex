defmodule ShortlabWeb.CoreComponents do
  @moduledoc """
  ...
  def shortcut_label(assigns) do
    ~H"""
    <div
      style={"background-color: #{@background_color};"}
      class="flex w-fit px-4 border rounded-full items-center content-center justify-center"
    >
      <p class="text-gray-100"><%= render_slot(@inner_block) %></p>
    </div>
    """
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ShortlabWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ShortlabWeb.Gettext, "errors", msg, opts)
    end
  end
